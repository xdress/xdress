...
from xdress.version import xdress_version, xdress_version_info
from xdress.utils import newoverwrite
from xdress.plugins import summarize_rcdocs
...
version = "{0}.{1}".format(*xdress_version_info[:2])

# The full version, including alpha/beta/rc tags.
release = xdress_version
...
# of the sidebar.
html_logo = '_static/HooverJoven.jpg'
...
latex_documents = [
  ('index', 'xdress.tex', u'XDress Documentation',
